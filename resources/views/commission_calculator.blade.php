	...
	<div class="container" style="margin: 3em auto;">
		...
		<div class="row">
			<div class="col-md-12">
					...
					<button type="submit" class="btn btn-secondary" id="calculate">Calculate</button>
			</div>
		</div>
	</div>
</section>
			...
			<div class="tab-content" id="myTabContent">
			  <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
			  	<table style="width: 100%;">
			  		<tr>
			  			<td style="width: 50%;">
			  				<p class="red" style="text-align:center;">Amount paid to current broker</p>
			  				<p class="red">$<span class="paidToBroker">0</span></p>
			  			</td>
			  			<td style="width: 50%;">
			  				<p style="text-align:center;">Amount paid to Taylor&nbsp;Properties</p>
			  				<p class="green">$<span class="taylor100Fees">0</span></p>
			  			</td>
			  		</tr>
			  		<tr>
			  			<td style="width: 50%;">
			  				<p class="red" style="text-align:center;">Amount earned with current broker</p>
			  				<p class="red">$<span class="earnedCurrentBroker">0</span></p>
			  			</td>
			  			<td style="width: 50%;">
			  				<p style="text-align:center;">Amount Earned Taylor&nbsp;Properties</p>
			  				<p class="green">$<span class="totalAmountEarned100">0</span></p>
			  			</td>
			  		</tr>
			  	</table>
			  </div>
			  <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
			  	<table style="width: 100%;">
			  		<tr>
			  			...
			  			<td style="width: 50%;">
			  				<p style="text-align:center;">Amount paid to Taylor&nbsp;Properties</p>
			  				<p class="green">$<span class="taylor85Fees">0</span></p>
			  			</td>
			  		</tr>
			  		<tr>
			  			<td style="width: 50%;">
			  			...
			  			<td style="width: 50%;">
			  				<p style="text-align:center;">Amount Earned Taylor&nbsp;Properties</p>
			  				<p class="green">$<span class="totalAmountEarned85">0</span></p>
			  			</td>
			  		</tr>
			  	</table>
			  </div>
