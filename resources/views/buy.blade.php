...
background-image: url({{ asset('images/welcomehome.jpg') }});
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-lg-6 ml-auto d-flex align-items-center mt-4 mt-md-0">
        <div>
          ...
          <p class="">Look online, at magazines and newspapers for houses you might be interested in. Make a note of those homes you and see how long they stay on the market. Also, note any changes in asking prices. This will give you a sense of the housing trends in specific areas.</p>
        </div>
      </div>
    </div>
    <div class="row">
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-lg-6 ml-auto d-flex align-items-center mt-4 mt-md-0">
        <div>
          ...
          <p class="">One of the most important steps in buying a home is getting financing. Before you even start searching for your dream home, talk to our <a href="https://heritagefinancial.com/">in-house lender</a> to determine what you can afford and learn about what types of loans are available. <!--a href="https://usmortgagecalculator.org/" target="_blank">See how much you can afford by using this mortage calculator.</a--></p>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-6 col-lg-6 ml-auto d-flex align-items-center mt-4 mt-md-0 order2">
        <div>
          ...
          <p class="">Start touring homes in your price range. Take notes on all the homes you visit. You will likely see a lot of houses! It can be hard to remember everything about them, so you might want to take pictures or video to help you remember each home.</p>
        </div>
      </div>
      <div class="col-md-6 order1">
        <div>
    ...
    <div class="row">
      <div class="col-md-6 col-lg-6 ml-auto d-flex align-items-center mt-4 mt-md-0 order2">
        <div>
          ...
          <p class="">You’ve found your dream home, your offer has been accepted, the financing is in place, and the inspection is complete. Now, there’s just one more key step in the process—closing! Prior to the closing date, expect to review the list of fees and the terms and conditions of the contract. In addition, you'll need to know the amount that you'll need to bring to closing. Your real estate agent and lender will assist you with this process.</p>
        </div>
      </div>
      <div class="col-md-6 order1">
        <div>
